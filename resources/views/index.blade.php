    ...
    <div class="main">
                ...
                <div class="container">
                    <div class="navigation-bar">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="logo">
                                    <a href="index.blade.php"><span class="fa fa-viacoin"></span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="vira-card">
                            ...
                            <div class="vira-card-content">
                                ...
                                <p>
                                    Complimenten, bewonderend gefluit en lonkende blikken zijn enkele risico’s die The
                                    Garment Club met zichlaim meebrengt. Onze enige missiede
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="expert-slider" class="owl-carousel">
                            <div class="item">
                                <p>
                                    ...
                                    the overall proposition. Organically grow the holistic world view of
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a class="popup-youtube btn" href="https://www.youtube.com/watch?v=4KRHIbsl8BE"><span
                    ...
                    <div class="col-sm-12">
                        <div class="social-icons">
                            <ul>
                                ...
                                <a href="#">
                                    <li><span class="ion-social-pinterest"></span></li>
                                </a>
                            </ul>
                        </div>
                    </div>
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <p> Handcrafted with <span class="fa fa-heart"></span> by <a href="http://themewagon.com/">ThemeWagon</a>
                        </p>
                    </div>
                </div>
            </div>
